  ...
  return (
    <div className="flex flex-col items-center justify-between w-full text-[#fff] py-4 sticky top-0 bg-[#121315] z-20">
      <div className="flex items-center justify-between w-full ">
        ...
        <button onClick={handleToggle} className="bg-[#1B95AC] group text-white rounded-3xl py-2 px-5 flex gap-x-2 items-center justify-center">
          <MdArrowOutward />
        </button>
      </div>
      <div className={`${openNav ? 'opacity-1 h-fit top-16 ' : 'bottom-0 opacity-0 h-[0] '} w-full mt-3 absolute z-10 bg-[#121315] transition-none`}>
        <nav>
